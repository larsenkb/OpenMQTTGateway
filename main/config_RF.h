...
/*-------------------PIN DEFINITIONS----------------------*/
    ...
    #ifdef ESP8266
        #define RF_RECEIVER_PIN D7 //0 // D3 on nodemcu // put 4 with rf bridge direct mod 
    #elif ESP32
    ...
    #ifdef ESP8266
        #define RF_EMITTER_PIN D8 // RX on nodemcu if it doesn't work with 3, try with 4 (D2) // put 5 with rf bridge direct mod
    #elif ESP32
