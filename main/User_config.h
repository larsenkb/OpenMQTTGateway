...
//#define WifiManager_password "liahona" //this is going to be the WPA2-PSK password for the initial setup access point 
...
char mqtt_server[40] = "192.168.1.65";
char mqtt_port[6] = "1883";

#ifndef Gateway_Name
  #define Gateway_Name "OpenMQTTGateway"
//  #define Gateway_Name "rfmqttGW"
#endif
...
#define simpleReceiving false //comment if you don't want to use old way reception analysis
